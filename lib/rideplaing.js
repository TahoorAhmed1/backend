...
function normalizeScope(scope = {}) {
  ...
  return {
    driverIds: toArray(scope.driverId ?? scope.driverIds),
    tripIds: toArray(scope.tripId ?? scope.tripIds),
    routeIds: toArray(scope.routeId ?? scope.routeIds),
...
async function syncPendingRidesForWeek(weekStartDate, scope = {}) {
  const { driverIds: scopeDriverIds, tripIds: scopeTripIds, routeIds: scopeRouteIds, skipNotifications } =
