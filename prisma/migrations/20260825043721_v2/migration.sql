...
-- CreateEnum
CREATE TYPE "DriverShiftType" AS ENUM ('TWELVE_HOUR', 'TWENTY_FOUR_HOUR', 'SINGLE_SHIFT', 'FIXED_SHIFT');
...
CREATE TABLE "RidePassenger" (
    ...
    "area" TEXT,
    "subArea" TEXT,
    "confirmationStatus" "RideConfirmationStatus" NOT NULL DEFAULT 'PENDING',
